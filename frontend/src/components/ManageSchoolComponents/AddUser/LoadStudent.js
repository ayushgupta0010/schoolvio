...
const LoadStudent = ({ student, handleChange, cleanForm, setUser }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    client
      .mutate({
        mutation: VERIFY_STUDENT_MUTATION,
        variables: {
  ...
  const handleUnverify = () => {
    ...
    client
      .mutate({
        mutation: UNVERIFY_STUDENT_MUTATION,
        variables: { username: student.user.username },
      })
      .then((res) => {
        alert("Unverified");
        cleanForm();

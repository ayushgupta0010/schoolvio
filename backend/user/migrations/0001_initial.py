    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(blank=True, choices=[('student', 'student'), ('teacher', 'teacher'), ('school', 'school')], max_length=9, null=True)),
                ...
                ('reason', models.CharField(blank=True, max_length=100, verbose_name='Reason for suspension')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='fcm', to=settings.AUTH_USER_MODEL)),
            ],
        ),
    ]
